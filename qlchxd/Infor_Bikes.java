...
public class Infor_Bikes extends javax.swing.JInternalFrame {
    ...
    private void fetchDataByBrand() {
        ...
        try (Connection conn = DriverManager.getConnection(connectionUrl, user, password)) {
            String sql = "SELECT MaXe, TenXe, HangXe, LoaiXe, GiaBan, SoLuongTonKho FROM ThongTinXeDap WHERE HangXe LIKE N'%"+Search_field.getText()+"%' or TenXe LIKE N'%"+Search_field.getText()+"%' ";
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        DataTableBikes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ma Xe", "Ten Xe", "Hang Xe", "Loai Xe", "Gia ban", "Ton kho"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Panel_DuLieu, javax.swing.GroupLayout.DEFAULT_SIZE, 671, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void Update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update_btnActionPerformed
        ...
        try (Connection conn = DriverManager.getConnection(connectionUrl, user, password)) {
            ...
            pstmt.setInt(6, Integer.parseInt(ID_Trans.getText()));   // MaXe
